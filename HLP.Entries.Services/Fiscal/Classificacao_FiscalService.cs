...
namespace HLP.Entries.Services.Fiscal
{
    ...
    public class Classificacao_FiscalService
    {
        ...
        public Classificacao_FiscalService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_ClassificacaoFiscal();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_ClassificacaoFiscal.Iwcf_ClassificacaoFiscalClient();
