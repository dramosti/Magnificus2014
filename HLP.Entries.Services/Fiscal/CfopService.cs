...
namespace HLP.Entries.Services.Fiscal
{
    ...
    {
        const string xTabela = "Cfop;";

        HLP.Wcf.Entries.wcf_Cfop serviceNetwork;
        wcf_Cfop.Iwcf_CfopClient serviceWeb;
        ...
        public CfopService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_Cfop();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_Cfop.Iwcf_CfopClient();
