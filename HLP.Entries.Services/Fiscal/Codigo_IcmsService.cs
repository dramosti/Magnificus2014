...
namespace HLP.Entries.Services.Fiscal
{
    ...
    public class Codigo_IcmsService
    {
        const string xTabela = "Codigo_Icms_pai;Codigo_Icms;";

        HLP.Wcf.Entries.wcf_CodigoIcms serviceNetwork;
        wcf_CodigoIcms.Iwcf_CodigoIcmsClient serviceWeb;
        ...
        public Codigo_IcmsService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_CodigoIcms();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_CodigoIcms.Iwcf_CodigoIcmsClient();
