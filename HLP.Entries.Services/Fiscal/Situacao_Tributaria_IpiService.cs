...
{
    public class Situacao_Tributaria_IpiService
    {
        const string xTabela = "Situacao_tributaria_ipi;";

        HLP.Wcf.Entries.wcf_StIpi serviceNetwork;
        wcf_StIpi.Iwcf_StIpiClient serviceWeb;
        ...
        public Situacao_Tributaria_IpiService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_StIpi();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_StIpi.Iwcf_StIpiClient();
