...
namespace HLP.Entries.Services.Gerais
{
    public class Condicao_PagamentoService
    {
        ...
        public Condicao_PagamentoService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_CondicaoPagamento();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_CondicaoPagamento.Iwcf_CondicaoPagamentoClient();
