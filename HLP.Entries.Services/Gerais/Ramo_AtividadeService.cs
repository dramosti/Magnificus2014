...
namespace HLP.Entries.Services.Gerais
{
    ...
    public class Ramo_AtividadeService
    {
        const string xTabela = "Ramo_atividade;";

        HLP.Wcf.Entries.wcf_RamoAtividade serviceNetwork;
        wcf_RamoAtividade.Iwcf_RamoAtividadeClient serviceWeb;
        ...
        public Ramo_AtividadeService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_RamoAtividade();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_RamoAtividade.Iwcf_RamoAtividadeClient();
