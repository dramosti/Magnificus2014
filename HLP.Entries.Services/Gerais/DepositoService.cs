...
namespace HLP.Entries.Services.Gerais
{
    ...
    {
        const string xTabela = "Deposito;";

        HLP.Wcf.Entries.wcf_Deposito serviceNetwork;
        wcf_Deposito.Iwcf_DepositoClient serviceWeb;
        ...
        public DepositoService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_Deposito();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_Deposito.Iwcf_DepositoClient();
