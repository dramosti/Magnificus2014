...
namespace HLP.Entries.Services.Gerais
{
    ...
    {
        const string xTabela = "UF;";

        HLP.Wcf.Entries.wcf_Uf serviceNetwork;
        wcf_Uf.Iwcf_UfClient serviceWeb;
        ...
        public UfService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_Uf();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_Uf.Iwcf_UfClient();
