...
namespace HLP.Entries.Services.Gerais
{
    ...
    {
        const string xTabela = "Moeda;";

        HLP.Wcf.Entries.wcf_Moeda serviceNetwork;
        wcf_Moeda.Iwcf_MoedaClient serviceWeb;
        ...
        public MoedaService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_Moeda();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_Moeda.Iwcf_MoedaClient();
