...
namespace HLP.Entries.Services.Crm
{
    ...
    {
        const string xTabela = "Fidelidade;";

        HLP.Wcf.Entries.wcf_Fidelidade serviceNetwork;
        wcf_Fidelidade.Iwcf_FidelidadeClient serviceWeb;
        ...
        public FidelidadeService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_Fidelidade();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_Fidelidade.Iwcf_FidelidadeClient();
