...
namespace HLP.Entries.Services.RecursosHumanos
{
    ...
    {
        const string xTabela = "Departamento;";

        HLP.Wcf.Entries.wcf_Departamento serviceNetwork;
        wcf_Departamento.Iwcf_DepartamentoClient serviceWeb;
        ...
        public DepartamentoService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_Departamento();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_Departamento.Iwcf_DepartamentoClient();
