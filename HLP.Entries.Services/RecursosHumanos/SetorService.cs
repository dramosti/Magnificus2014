...
namespace HLP.Entries.Services.RecursosHumanos
{
    ...
    {
        const string xTabela = "Setor;";

        HLP.Wcf.Entries.wcf_Setor serviceNetwork;
        wcf_Setor.Iwcf_SetorClient serviceWeb;
        ...
        public SetorService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_Setor();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_Setor.Iwcf_SetorClient();
