...
namespace HLP.Entries.Services.Transportes
{
    ...
    {
        const string xTabela = "Modos_entrega;";

        HLP.Wcf.Entries.wcf_ModoEntrega serviceNetwork;
        wcf_ModoEntrega.Iwcf_ModoEntregaClient serviceWeb;
        ...
        public ModoEntregaService()
        {
            switch (Sistema.bOnline)
            {
                case StConnection.OnlineNetwork:
                    {
                        serviceNetwork = new HLP.Wcf.Entries.wcf_ModoEntrega();
                ...
                case StConnection.OnlineWeb:
                    {
                        serviceWeb = new wcf_ModoEntrega.Iwcf_ModoEntregaClient();
